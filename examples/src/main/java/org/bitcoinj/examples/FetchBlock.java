...
/**
 * 从远程或本地主机节点的块散列中下载该块，并将其打印出来。
 * 从本地主机下载时，在本地运行bitcoind:bitcoind -testnet - daemon
 * 在bitcoind启动和运行后，使用命令:org . bitcoinj.示例
 */
public class FetchBlock {
    public static void main(String[] args) throws Exception {
        ...
        // Connect to testnet and find a peer 连接到testnet并找到一个对等点
        ...
        // Retrieve a block through a peer 通过对等点检索块
